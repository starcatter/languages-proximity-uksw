...
from analyzeAndShow.constants_mysql import tb_names, lang_list, db_names
...
def get_df_from_db(db_name):
    ...
    only_translations = tb_df[lang_list].applymap(unidecode).applymap(str.lower).applymap(lambda x: re.sub(r'[^a-zA-Z ]', "", x))
