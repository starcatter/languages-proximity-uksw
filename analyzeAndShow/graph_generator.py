...
from analyzeAndShow.constants_mysql import languages, categories
...
parser.add_argument("--lang", "-l", choices=languages + ["all"], required=True, metavar='L', nargs='+', help="languages for comparison, at least 2")
parser.add_argument("--cat", "-c", choices=categories + ["all"], required=True, metavar='C', nargs='+', help="at least one category")
